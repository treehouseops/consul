...
func init() {
	...
	registerEndpoint("/v1/internal/datacenter-configs", []string{"GET"}, (*HTTPServer).DatacenterConfigList)
	registerEndpoint("/v1/internal/datacenter-config/", []string{"GET"}, (*HTTPServer).DatacenterConfigGet)
